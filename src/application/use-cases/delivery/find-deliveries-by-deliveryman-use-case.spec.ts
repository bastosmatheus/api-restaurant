...
describe("get deliveries by deliveryman", () => {
  ...
  it("should be possible to get deliveries by deliveryman (string | null)", async () => {
    ...
    const deliveries = await findDeliveriesByDeliverymanUseCase.execute({ id_deliveryman: null });
