...
import { FindOrdersFoodsByFoodUseCase } from "./find-orders-foods-by-food-use-case";
...
let findOrdersFoodsByFoodUseCase: FindOrdersFoodsByFoodUseCase;
let bcryptAdapter: BcryptAdapter;

describe("get order food by food", () => {
  beforeEach(() => {
    ...
    findOrdersFoodsByFoodUseCase = new FindOrdersFoodsByFoodUseCase(orderFoodRepository);
  });

  it("should be possible to get order food by food", async () => {
    ...
    const orderFood = await findOrdersFoodsByFoodUseCase.execute({ id_food });
