...
import { FindOrdersByPixsUseCase } from "./find-orders-by-pixs-use-case";
...
let findOrdersByPixsUseCase: FindOrdersByPixsUseCase;
let bcryptAdapter: BcryptAdapter;

describe("get orders by pixs", () => {
  beforeEach(() => {
    ...
    findOrdersByPixsUseCase = new FindOrdersByPixsUseCase(orderRepository);
  });

  it("should be possible to get orders by pixs", async () => {
    ...
    const orders = await findOrdersByPixsUseCase.execute();
